...
const styles = StyleSheet.create({
  ...
  eyebrow: { letterSpacing: 4, color: '#6366f1', fontSize: 11, textTransform: 'uppercase' },
  title: { marginTop: 4, marginBottom: 12, color: '#f8fafc', fontSize: 22, fontWeight: '600' },
  linkRow: { marginBottom: 16, paddingVertical: 10 },
  linkText: { color: '#a5b4fc', fontWeight: '600', fontSize: 14 },
  navLink: { color: '#94a3b8', fontWeight: '600', fontSize: 14 },
  navLinkStrong: { color: '#6366f1', fontWeight: '700', fontSize: 15 },
  muted: { color: '#64748b', marginTop: 24, fontSize: 14 },
  ...
  cardHint: { fontSize: 12, color: '#a5b4fc' },
});
